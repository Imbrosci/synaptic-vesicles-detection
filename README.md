...
•	Due to incompatibility issues we recommend to use python 3.6. In case your python version is different you may want to create and activate a virtual environment.
...
•	xlsxwriter, you can use the following command: conda install xlsxwriter
•	pillow, you can use the following command: conda install pillow
•	pytorch torchvision (follow the instruction at: https://pytorch.org/ )
