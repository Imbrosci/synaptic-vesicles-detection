...
2)	opencv, to install opencv you may try one of the following commands:
* python -m pip install opencv-python
* conda install –c https://conda.binstar.org/menpo opencv
* conda install –c conda-forge opencv 
if, after installation, the module cv2 is not found you may need to uninstall opencv and try to install it with another command.
