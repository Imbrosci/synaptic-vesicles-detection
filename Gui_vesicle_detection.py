...
class VesAnalysisGui(tk.Frame):
    ...
    def image_plus_results2(self):
        ...
        if error_free == 1:
            ...
            if (mask != 'Not found') and (
                    df_labels.columns[-1] == 'Area (nm²)'):
                self.ax.imshow(mask)
    ...
    def plot(self):
        ...
        a = sns.swarmplot(x='Experiment', y='Vesicles count', data=df_data1,
                          ax=ax1)
        a.set_xlabel('Name of experiment', fontsize=12, position=(8, 0.3))
        ...
        b.set_xlabel('Name of experiment', fontsize=12, position=(8, 3.6))
        ...
        if columns == 3:
            ...
            c = sns.swarmplot(x='Experiment', y='Area (nm²)', data=df_data3,
                              ax=ax3)
            c.set_xlabel('Name of experiment', fontsize=12, position=(8, 6.9))
